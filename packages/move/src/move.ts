...
export async function moveSync(src: string, dest: string, opts: MoveOptions): Promise<void> {
...
export function moveAsync(src: string, dest: string, opts: MoveOptions): void {
