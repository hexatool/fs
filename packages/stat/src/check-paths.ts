...
export async function checkPaths(src: string, dest: string, funcName: FunctionName, opts?: GetStatsOptions): Promise<CheckStatsResult> {
...
export function checkPathsSync(src: string, dest: string, funcName: FunctionName, opts?: GetStatsOptions): CheckStatsResult {
